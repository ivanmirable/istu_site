        ...
        <div class="row">
            ...
            <div class="posts col-9">
                ...
                <div class="row tittle-table">
                    ...
                    <div class="col-2">Адрес выдачи</div>
                    <div class="col-2">Номер транзакции</div>
                    <div class="col-1">Управление</div>
                </div>
                <?php foreach($ordeps as $key=> $ordep):?>

                <div class="row post">
                    <div class="id col-2"><?=$ordep['email']?></div>
                    <div class="tittle col-4"><?=$ordep['buy_date'];?></div>
                    <div class="price col-2"><?=$ordep['adress_pickup'];?></div>
                    <div class="price col-2"><a href="transaction.php?transaction_number=<?=$ordep['transaction_number']?>"><?=$ordep['transaction_number'];?></a></div>
                    <div class="red col-1"><a href="cart.php?buy_date=<?=$ordep['buy_date'];?>">Подробнее</a></div>
                </div>
                <?php endforeach;?>
            </div>
        </div>
