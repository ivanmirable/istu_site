...
$transactions = selectAll('transaction',['transaction_number'=>$_GET['transaction_number']]);
?>
<!doctype html>
<html lang="ru">
  <head>
        ...
        <div class="row">
            ...
            <div class="posts col-9">
                ...
                <div class="row tittle-table">
                    ...
                    <div class="col-4">Метод оплаты</div>
                    <div class="col-2">Сумма оплаты</div>

                </div>
                <?php foreach($transactions as $key=> $transaction):?>

                <div class="row post">
                    <div class="id col-2"><?=$transaction['transaction_number']?></div>
                    <div class="tittle col-4"><?=$transaction['pay_method'];?></div>
                    <div class="price col-2"><?=$transaction['pay_sum'];?></div>
                </div>
                <?php endforeach;?>
            </div>
        </div>
